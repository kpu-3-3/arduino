...
//1일때가 약물 없고 먹은 상태 0일때가 약물잇음, 안먹은 상태
     cur++;
    ...
    if(cur-prev==10){ //안드로이드에 데이터 전송 
      ...
      else {Serial.println("1번 미복용");bt.print("18");setNeopixel();}//미복용상태전송
      ...
      else {Serial.println("2번 미복용");bt.print("28");setNeopixel();}
      ...
      else  {Serial.println("3번 미복용");bt.write("38");setNeopixel();}
      ...
      else{Serial.println("4번 미복용");bt.write("48");setNeopixel();}
